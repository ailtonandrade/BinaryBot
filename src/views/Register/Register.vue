          ...
          <div class="card-body">
            <form>
              ...
              <div class="mb-6">
                ...
                <input type="text" class="form-control" id="number-address" v-model="acc.NumberAddress"
                  @change="methods.validateNumberAddress()" />
                <span class="textError">{{ error.NumberAddress }}</span>
              </div>
              <div class="mb-6">
  ...
  setup() {
    ...
    const methods = {
      ...
      formatInput() {
        ...
        acc.value.NumberAddress = auxiliar.formatOnlyCharsAndNumbers(acc.value.NumberAddress);
      ...
      validateNumberAddress() {
        if (acc.value.NumberAddress.length == 0) {
          error.value.NumberAddress = "Campo obrigatório.\n";
        } else {
          error.value.NumberAddress = "";
        }
      },
